...
const mesTutos = document.createElement('h2');
mesTutos.textContent='Mes tutoriels JavaScript';

document.body.appendChild(mesTutos);

const tutos  = [
    { name: "Openclassrooms : Apprenez à coder avec JavaScript :", url: "https://openclassrooms.com/fr/courses/2984401-apprenez-a-coder-avec-javascript" },
    { name: "Openclassrooms : Créez des pages web interactives avec JavaScript :", url: "https://openclassrooms.com/fr/courses/3306901-creez-des-pages-web-interactives-avec-javascript/" },
    { name: "Udemy : The Complete JavaScript Course 2019 : Build Real Projects! sur UDEMY", url: "https://www.udemy.com/course/the-complete-javascript-course" }
];

tutos.forEach(function (tutoriels) {
